                        ...
                        <div class="our_solution_category">
                            <div class="solution_cards_box">
                                <div class="solution_card">
                                    ...
                                    <div class="solu_description">
                                        <p>
                                            {!! \Illuminate\Support\Str::limit($question3->content, 60, $end='...') !!}
                                        </p>
                                ...
                                <div class="solution_card">
                                    ...
                                    <div class="solu_description">
                                        <p>
                                            {!! \Illuminate\Support\Str::limit($question4->content, 60, $end='...') !!}
                                        </p>
                                        <button type="button" class="read_more_btn">بیشتر بخوانید</button>
                                    </div>
                                </div>
                            ...
                            <div class="solution_cards_box sol_card_top_3">
                                <div class="solution_card">
                                    ...
                                    <div class="solu_description">
                                        <p>
                                            {!! \Illuminate\Support\Str::limit($question1->content, 60, $end='...') !!}
                                        </p>
                                        <button type="button" class="read_more_btn">بیشتر بخوانید</button>
                                    </div>
                                </div>
                                <div class="solution_card">
                                    ...
                                    <div class="solu_description">
                                        <p>
                                            {!! \Illuminate\Support\Str::limit($question2->content, 60, $end='...') !!}
                                        </p>
                                        <button type="button" class="read_more_btn">بیشتر بخوانید</button>
                                    </div>
                                </div>
