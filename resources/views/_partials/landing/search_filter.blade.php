...
<div class="d-flex bg-light shadow rounded-3 p-2 mb-3">
    ...
    <a class="mx-2 rounded-3 text-muted p-2 {{request('type') == 'discuss' ? 'active-search' : ''}}" href="{{route('search',['search'=>request('search'),'type'=>'discuss'])}}"><i class="fa fa-lg fa-question-circle mx-2"></i>بحث و گفتگوها</a>
</div>
