<x-landing-layout title="جستجوی دوره‌ها"
                  description="در این قسمت می‌توانید تمامی دوره‌های جستجو شده را مشاهده کنید."
                  keywords="دوره‌ها">
<div class="container mt-3">
    @include('_partials.landing.search_filter')
    <h3 class="text-center main-color h2 mb-4">تعداد دوره‌های یافت شده: <span class="text-primary">{{$coursesCount}}</span></h3>
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        @empty
            <div style="width: 100%; min-height: 500px" class="text-center">
                <p class="mt-5 text-danger h5">در حال حاضر دوره‌ای با جستجوی شما پیدا نشد !</p>
            </div>
        @endforelse
    </div>
    @if($courses)
