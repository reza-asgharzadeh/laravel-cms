<x-landing-layout title="تمامی دوره‌های تخفیف خورده"
                  description="در این قسمت می‌توانید تمامی دوره‌های تخفیف خورده در سایت را مشاهده کنید."
                  keywords="تخفیف دوره"
                  pageUrl="{{route('courses.offer')}}">
<div class="container mt-5">
    <h3 class="text-center main-color h2 mb-3">دوره های تخفیف دار</h3>
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        @empty
            <div style="width: 100%; min-height: 500px" class="text-center">
                <p class="mt-5 text-danger h5">تخفیف پیشنهادی برای هیچ دوره ای وجود ندارد !</p>
