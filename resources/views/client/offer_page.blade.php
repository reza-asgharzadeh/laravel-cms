<x-landing-layout>
    <div class="container mt-5">
        <p class="text-center h4 text-primary mb-3">دوره های تخفیف دار:</p>
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            @empty
                <div style="width: 100%; min-height: 200px">
                    <p class="m-auto mt-5 text-center text-danger h5">تخفیف پیشنهادی برای هیچ دوره ای وجود ندارد !</p>
                </div>
            @endforelse
        </div>
    </div>
