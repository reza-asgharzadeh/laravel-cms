<x-landing-layout title="همه دوره‌ها با دسته بندی {{$category->name}}"
                  description="در این قسمت می‌توانید تمامی دوره‌ها با دسته بندی {{$category->name}} را مشاهده کنید"
                  keywords="دسته بندی دوره‌ها"
                  pageUrl="{{route('category.course.show',$category->slug)}}">
<div class="container mt-5">
    <h3 class="text-center main-color h2 mb-3">تمامی دوره ها با دسته بندی "{{$category->name}}"</h3>
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        @empty
            <div style="width: 100%; min-height: 500px" class="text-center">
                <p class="mt-5 text-danger h5">دوره ای برای دسته بندی "{{$category->name}}" یافت نشد !</p>
