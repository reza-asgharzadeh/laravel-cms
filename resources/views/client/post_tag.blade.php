<x-landing-layout title="همه مقالات با برچسب {{$tag->name}}"
                  description="در این قسمت می‌توانید تمامی مقالات با برچسب {{$tag->name}} را مشاهده کنید"
                  keywords="برچسب مقالات"
                  pageUrl="{{route('post.tag.show',$tag->slug)}}">
<div class="container mt-5">
    <h3 class="text-center main-color h2 mb-3">تمامی مقالات با برچسب "{{$tag->name}}"</h3>
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        @empty
            <div style="width: 100%; min-height: 500px" class="text-center">
                <p class="mt-5 text-danger h5">مقاله ای برای برچسب "{{$tag->name}}" یافت نشد !</p>
