<x-landing-layout>
    <div class="container mb-5">
        <p class="text-center h5 text-primary mb-3">دسته بندی های یافت شده:</p>
        <div class="row row-cols-1 row-cols-md-3 g-4">
            @if(isset($posts))
                ...
                @empty
                    <p class="m-auto mt-5 text-center text-danger">مقاله ای برای این دسته بندی یافت نشد !</p>
                @endforelse
            @else
                ...
                @empty
                    <p class="m-auto mt-5 text-center text-danger">دوره ای برای این دسته بندی یافت نشد !</p>
                @endforelse
            @endif
        </div>
    </div>
