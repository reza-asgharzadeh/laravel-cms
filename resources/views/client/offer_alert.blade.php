...
<div style="background: {{$alert->bg_color}}; color: {{$alert->title_color}}" class="alert alert-dismissible fade show m-0 p-2" role="alert">
    <div class="d-flex flex-column flex-lg-row justify-content-evenly align-items-center text-center">
        ...
        <div class='countdown h4' data-date="{{$alert->expiry_date->format('Y-m-d')}}" data-time="{{$alert->expiry_date->format('H:i:s')}}">
            <ul style="color: {{$alert->title_color}}" class="list-unstyled m-0 p-0">
                <li class="d-inline-block h5 m-0 p-0"><span class="seconds">00</span><p class="m-0 p-0">ثانیه</p></li>
                <li class="align-top d-inline-block">:</li>

                <li class="d-inline-block h5 m-0 p-0"><span class="minutes">00</span><p class="m-0 p-0">دقیقه</p></li>
                <li class="align-top d-inline-block">:</li>

                <li class="d-inline-block h5 m-0 p-0"><span class="hours">00</span><p class="m-0 p-0">ساعت</p></li>
                <li class="align-top d-inline-block">:</li>

                <li class="d-inline-block h5 m-0 p-0"><span class="days">00</span><p class="m-0 p-0">روز</p></li>
            </ul>
        </div>
    </div>
