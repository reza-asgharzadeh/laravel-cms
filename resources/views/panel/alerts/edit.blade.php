        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>
                        <small>ویرایش نوار اطلاع رسانی</small>
                    </h3>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <small>ویرایش اطلاع رسانی</small>
                            </h2>
                        ...
                        <div class="x_content">
                            <br/>
                            <form action="{{route('alerts.update',$alert->id)}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="title" name="title"
                                               class="form-control col-md-7 col-xs-12" value="{{$alert->title}}">
                                    </div>
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="btn_txt" name="btn_txt"
                                               class="form-control col-md-7 col-xs-12" value="{{$alert->btn_txt}}">
                                    </div>
                                    @error('btn_txt')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="link" name="link"
                                               class="form-control col-md-7 col-xs-12" value="{{$alert->link}}">
                                    </div>
                                    @error('link')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1 col-sm-6 col-xs-12">
                                        <input type="color" id="title_color" name="title_color"
                                               class="form-control col-md-7 col-xs-12" value="{{$alert->title_color}}">
                                    </div>
                                    @error('title_color')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1 col-sm-6 col-xs-12">
                                        <input type="color" id="btn_color" name="btn_color"
                                               class="form-control col-md-7 col-xs-12" value="{{$alert->btn_color}}">
                                    </div>
                                    @error('btn_color')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1 col-sm-6 col-xs-12">
                                        <input type="color" id="btn_bg_color" name="btn_bg_color"
                                               class="form-control col-md-7 col-xs-12" value="{{$alert->btn_bg_color}}">
                                    </div>
                                    @error('btn_bg_color')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1 col-sm-6 col-xs-12">
                                        <input type="color" id="btn_bg_hover_color" name="btn_bg_hover_color"
                                               class="form-control col-md-7 col-xs-12" value="{{$alert->btn_bg_hover_color}}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1 col-sm-6 col-xs-12">
                                        <input type="color" id="bg_color" name="bg_color"
                                               class="form-control col-md-7 col-xs-12" value="{{$alert->bg_color}}">
                                    </div>
                                    @error('bg_color')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
