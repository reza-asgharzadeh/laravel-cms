        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>
                        <small>ویرایش کد تخفیف دوره</small>
                    </h3>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br/>
                            <form action="{{route('coupons.update',$coupon->id)}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="code" name="code"
                                               class="form-control col-md-7 col-xs-12" value="{{$coupon->code}}">
                                    </div>
                                    @error('code')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="value" name="value"
                                               class="form-control col-md-7 col-xs-12" value="{{$coupon->value}}">
                                    </div>
                                    @error('value')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
